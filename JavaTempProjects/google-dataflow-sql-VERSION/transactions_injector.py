...
while True:
  ...
  #Original version :   command = "gcloud --project={} pubsub topics publish transactions --message='{}'".format(project, message) - do not work on windows
  command = "gcloud --project={} pubsub topics publish transactions --message={}".format(project, message)

  #Windows issue with quotes windows needs """ instead of "
