...
import ch22CollectionsInPractice.models.*;
import ch22CollectionsInPractice.utilities.GenderType;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Book book2 = new Book("d2","Better Java","Joe Le Blanc","23456","Anytown Branch",150);
		Book book3 = new Book("Book 2","Better Java book2","Joe Le Blanc","23456","Anytown Branch",150);
