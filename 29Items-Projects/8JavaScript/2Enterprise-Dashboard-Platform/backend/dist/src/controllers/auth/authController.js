import { authService, authSchemas } from '@/middleware/auth/authMiddleware.js';
    ...
    checkLoginRateLimit(ip) {
        ...
        if (attempt) {
            ...
            if (attempt.count >= MAX_LOGIN_ATTEMPTS) {
                ...
                throw new AppError(`Too many login attempts. Please try again in ${remainingTime} minutes.`, 429, 'RATE_LIMIT_EXCEEDED');
            }
        }
    }
    trackFailedLogin(ip) {
...
export const { register, login, refresh, logout, changePassword, forgotPassword, resetPassword, verifyToken, getCurrentUser, } = authController;
