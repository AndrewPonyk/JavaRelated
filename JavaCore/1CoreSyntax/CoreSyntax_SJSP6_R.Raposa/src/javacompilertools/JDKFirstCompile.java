...
public class JDKFirstCompile {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		System.out.println("Compile Java code in Runtime");
...
/*
 * // File: MyClass.java class MyClass { public static void main(String args[])
