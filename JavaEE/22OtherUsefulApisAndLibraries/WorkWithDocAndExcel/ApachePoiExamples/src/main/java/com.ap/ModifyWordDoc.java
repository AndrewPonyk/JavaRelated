...
public class ModifyWordDoc {
    ...
    public static void main(String[] args) throws IOException {
        ...
        XWPFDocument doc = new XWPFDocument(new FileInputStream("D:\\temp\\letter-template.docx"));
        ...
        doc.getTables().forEach(tbl -> {
            ...
            IntStream.range(0, table1Source.size()).forEach(i -> {
                ...
                final StrSubstitutor substitutor = new StrSubstitutor(table1Source.get(i), "${", "}");
