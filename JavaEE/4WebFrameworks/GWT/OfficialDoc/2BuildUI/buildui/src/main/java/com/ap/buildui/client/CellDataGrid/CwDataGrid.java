package com.ap.buildui.client.CellDataGrid;


import com.ap.buildui.client.CellDataGrid.ContactDatabase.Category;
import com.ap.buildui.client.CellDataGrid.ContactDatabase.ContactInfo;
 ...
 * @author andrew
 */
public class CwDataGrid extends Composite{
    interface CwDataGridUiBinder extends UiBinder<Widget, CwDataGrid> {
    }
    
    private static CwDataGridUiBinder uiBinder = GWT.create(CwDataGridUiBinder.class);
    /**
     * The main DataGrid.
     */
    ...
    String cwDataGridColumnAddress = "Column Address";

    String cwDataGridColumnAge = "Column Age";

    String cwDataGridColumnCategory = "Column Category";

    String cwDataGridColumnFirstName = "Column First Name";

    String cwDataGridColumnLastName = "Column Last Name";

    String cwDataGridDescription = "Column Description";

    String cwDataGridEmpty = "Empty";

    String cwDataGridName = "Grid Name";
  }
 ...
 /**
  ...
  public void onInitialize() {
    ...
    dataGrid.setEmptyTableWidget(new Label(CwConstants.cwDataGridEmpty));
  ...
  private void initTableColumns(final SelectionModel<ContactInfo> selectionModel,
    ...
    dataGrid.addColumn(firstNameColumn, CwConstants.cwDataGridColumnFirstName);
    ...
    dataGrid.addColumn(lastNameColumn, CwConstants.cwDataGridColumnLastName);
    ...
    dataGrid.addColumn(ageColumn, new SafeHtmlHeader(SafeHtmlUtils.fromSafeConstant(CwConstants
    ...
    dataGrid.addColumn(categoryColumn, CwConstants.cwDataGridColumnCategory);
    ...
    dataGrid.addColumn(addressColumn, CwConstants.cwDataGridColumnAddress);
